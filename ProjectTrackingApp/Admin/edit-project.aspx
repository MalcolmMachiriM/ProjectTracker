<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMain.Master" AutoEventWireup="true" CodeBehind="edit-project.aspx.cs" Inherits="ProjectTrackingApp.Admin.edit_project" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form role="form" runat="server">
        ...
        <div class="row">
            <div class="col-md-6">
                <asp:Button ID="btnSave" runat="server" Text="Update Project Details" class="btn btn-success" OnClick="btnSave_Click" />
            </div>
        </div>
