<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMain.Master" AutoEventWireup="true" CodeBehind="assign-memnbers.aspx.cs" Inherits="ProjectTrackingApp.Admin.assign_memnbers" %>
                                        ...
                                        <tr>
                                            <td colspan="12">
                                                <asp:GridView ID="grdMember" ClientIDMode="Static" Width="100%" runat="server"
                                                    ...
                                                    DataKeyNames="ID" OnPageIndexChanging="grdMember_PageIndexChanging"
