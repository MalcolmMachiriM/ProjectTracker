<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMain.Master" AutoEventWireup="true" CodeBehind="allocate-resources.aspx.cs" Inherits="ProjectTrackingApp.Admin.allocate_resources" %>
                         ...
                         <div class="position-center">
                             <form role="form" runat="server">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-6">
                                         <div class="form-group">
                                             <label for="txtEmail">Resource Name</label>
                                             <asp:Textbox ID="txtResource" CssClass="form-control dropdown" runat="server" Enabled="false" Style="color: black; font-weight: bold;"></asp:Textbox>
                                         </div>
                                     </div>
                                     <div class="col-md-6">
                                         <div class="form-group">
