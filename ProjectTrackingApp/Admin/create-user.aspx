                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <asp:Panel ID="pnlProject" runat="server" Visible="false">
                                                <div class="form-group">
                                                    <label for="drpProjects">Project</label>
                                                    <asp:DropDownList ID="drpProjects" CssClass="form-control dropdown" AutoPostBack="true" OnSelectedIndexChanged="drpRole_SelectedIndexChanged" runat="server" Style="color: black; font-weight: bold;"></asp:DropDownList>
                                                </div>
                                            </asp:Panel>
                                        </div>
                                    </div>
